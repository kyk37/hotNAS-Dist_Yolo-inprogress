...
def yolo3_predictions(feature_maps, feature_channel_nums, num_anchors, num_classes, use_spp=False):
    ...
    if use_spp:
        x, y1 = make_spp_last_layers(f1, f1_channel_num//2, num_anchors * (num_classes + 5+1), predict_id='1')
    else:
        x, y1 = make_last_layers(f1, f1_channel_num//2, num_anchors * (num_classes + 5+1), predict_id='1')
    ...
    x, y2 = make_last_layers(x, f2_channel_num//2, num_anchors*(num_classes+5+1), predict_id='2')
    ...
    x, y3 = make_last_layers(x, f3_channel_num//2, num_anchors*(num_classes+5+1), predict_id='3')
...
def yolo3lite_predictions(feature_maps, feature_channel_nums, num_anchors, num_classes, use_spp=False):
    ...
    #feature map 1 head & output (13x13 for 416 input)
    if use_spp:
        x, y1 = make_spp_depthwise_separable_last_layers(f1, f1_channel_num//2, num_anchors * (num_classes + 5+1), block_id_str='pred_1', predict_id='1')
    else:
        x, y1 = make_depthwise_separable_last_layers(f1, f1_channel_num//2, num_anchors * (num_classes + 5+1), block_id_str='pred_1', predict_id='1')
    ...
    #feature map 2 head & output (26x26 for 416 input)
    x, y2 = make_depthwise_separable_last_layers(x, f2_channel_num//2, num_anchors * (num_classes + 5+1), block_id_str='pred_2', predict_id='2')
    ...
    #feature map 3 head & output (52x52 for 416 input)
    x, y3 = make_depthwise_separable_last_layers(x, f3_channel_num//2, num_anchors * (num_classes + 5+1), block_id_str='pred_3', predict_id='3')
...
def tiny_yolo3_predictions(feature_maps, feature_channel_nums, num_anchors, num_classes):
    ...
    y1 = compose(
            ...
            DarknetConv2D(num_anchors*(num_classes+5+1), (1,1), name='predict_conv_1'))(x1)
    ...
    y2 = compose(
            ...
            DarknetConv2D(num_anchors*(num_classes+5+1), (1,1), name='predict_conv_2'))([x2, f2])
